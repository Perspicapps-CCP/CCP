...
from delivieries.schemas import DeliveryDetailResponseSchema, DeliveryItemResponseSchema, WarehouseSchema

# Add to your schemas.py file
def create_mock_delivery_detail() -> DeliveryDetailResponseSchema:
    ...
    for _ in range(random.randint(1, 10)):
        ...
        orders.append(
            DeliveryItemResponseSchema(
                ...
                images=[f"https://picsum.photos/id/{random.randint(1, 1000)}/600/400" for _ in range(random.randint(1, 5))],
            )
        )
    ...
    return DeliveryDetailResponseSchema(
        shipping_number=fake.bothify("FDX##########"),
        licence_plate=fake.bothify("??-####"),
